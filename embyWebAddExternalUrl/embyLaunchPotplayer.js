...
(function () {
    ...
    function init() {
        ...
        let buttonhtml = `<div id="ExternalPlayersBtns" class ="detailButtons flex align-items-flex-start flex-wrap-wrap">
            ...
            <button id="embyDDPlay" type="button" class="detailButton  emby-button emby-button-backdropfilter raised-backdropfilter detailButton-primary" title="MPV"> <div class="detailButton-content"> <i class="md-icon detailButton-icon button-icon button-icon-left icon-DDPlay">　</i>  <span class="button-text">DDPlay</span> </div> </button>
        ...
        document.querySelector("div[is='emby-scroller']:not(.hide) #embyDDPlay").onclick = embyDDPlay;
        ...
        document.querySelector("div[is='emby-scroller']:not(.hide) .icon-DDPlay").style.cssText += 'background: url(https://fastly.jsdelivr.net/gh/bpking1/embyExternalUrl@main/embyWebAddExternalUrl/icons/icon-DDPlay.webp)no-repeat;background-size: 100% 100%;font-size: 1.4em';
    ...
    async function getEmbyMediaInfo() {
        ...
        let streamUrl = `${domain}/${streamName}.${streamExt}?api_key=${ApiClient.accessToken()}&Static=true&MediaSourceId=${mediaSourceId}`;
