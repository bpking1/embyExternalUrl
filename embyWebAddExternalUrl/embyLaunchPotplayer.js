        ...
        if (!potplayer) {
            ...
            if (mainDetailButtons) {
                let buttonhtml = `<div class ="detailButtons  flex align-items-flex-start flex-wrap-wrap">
                  ...
                  <button id="embyStellarPlayer" type="button" class="detailButton  emby-button emby-button-backdropfilter raised-backdropfilter detailButton-primary" title="StellarPlayer"> <div class="detailButton-content"> <i class="md-icon detailButton-icon button-icon button-icon-left icon-StellarPlayer">　</i>  <span class="button-text">恒星播放器</span> </div> </button>
