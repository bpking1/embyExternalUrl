...
// pelx 不需要 "transcode", 可用 "proxy" 代替,稍微有些歧义,这里只是交给原始服务中转处理,具体是否转码由 plex 客户端自己判断上报的
...
const plexMountPath = [""];
// 访问宿主机上 5244 端口的 alis 地址, 要注意 iptables 给容器放行端口
const alistAddr = "";
...
// alist公网地址,用于需要 alist server 代理流量的情况, 按需填写
